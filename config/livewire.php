...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Raised from Livewire's own default (['required', 'file', 'max:12288'],
        // 12MB) to match config/media-library.php's max_file_size (200MB) —
        // this project's largest uploads (SiteSetting.ebook, HomeVideoHero.video)
        // need up to 200MB, and Livewire's temporary-upload endpoint validates
        // against this global rule BEFORE any per-field ->maxSize() on the
        // Filament FileUpload component ever runs, so it silently overrode
        // every field's own higher limit until this was set explicitly.
